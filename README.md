...
This repository contains a Karabiner-Elements complex modification rule for macOS users who are used to the Windows-style input method switching workflow.
